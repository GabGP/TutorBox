...
/**
 * Unified Login and Account Signup Form component.
 * Supports authentication against `/auth/login` and student registration
 * via `/users/signup` with validation feedback and keyboard shortcuts.
 *
 * @param {LoginFormProps} props - Component props controlling form mode, submission handlers, and titles.
 * @returns {JSX.Element} The rendered login and signup card.
 */
